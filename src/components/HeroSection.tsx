    ...
    <section className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center py-20">
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-12 animate-fade-in" style={{ animationDelay: "0.3s" }}>
          <div className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-card border border-border shadow-sm hover:shadow-md hover:scale-105 transition-all duration-200 ease-in-out">
        ...
        <div className="mt-20 p-8 rounded-2xl bg-card border border-border shadow-xl max-w-2xl mx-auto animate-fade-in hover:shadow-2xl transition-all duration-200 ease-in-out" style={{ animationDelay: "0.5s" }}>
